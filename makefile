...
ODM_FLAG += -DODMM_CONFIG_PARTITION_UPGRADE
ODM_FLAG += -DODMM_CONFIG_OEM_FUNCTION
ODM_FLAG += -DODMM_CONFIG_OEM_DUMP_MEMORY
ODM_FLAG += -DODMM_CONFIG_ENABLE_FLASH_IMAGE
ODM_FLAG += -DODMM_CONFIG_OEM_SHUTDOWN
CFLAGS += $(ODM_FLAG)
